...
public class TopicProducer {
    ...
    public TopicProducer(String topicName) throws Exception {

        initProducer(topicName, true);
    }
    public TopicProducer(String topicName, boolean persistentflag) throws Exception {

        initProducer(topicName, persistentflag);
    }
    ...
    private void initProducer(String topicName, boolean persistentflag) throws Exception{
